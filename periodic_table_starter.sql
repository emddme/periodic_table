...
CREATE DATABASE periodic_table WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'en_CA.UTF-8' LC_CTYPE = 'en_CA.UTF-8';
...
--
-- Name: elements; Type: TABLE; Schema: public; Owner: vanpuffelen
--
...
ALTER TABLE public.elements OWNER TO vanpuffelen;

--
-- Name: properties; Type: TABLE; Schema: public; Owner: vanpuffelen
--
...
ALTER TABLE public.properties OWNER TO vanpuffelen;

--
-- Data for Name: elements; Type: TABLE DATA; Schema: public; Owner: vanpuffelen
--
...
--
-- Data for Name: properties; Type: TABLE DATA; Schema: public; Owner: vanpuffelen
--
...
--
-- Name: elements elements_atomic_number_key; Type: CONSTRAINT; Schema: public; Owner: vanpuffelen
--
...
--
-- Name: elements elements_pkey; Type: CONSTRAINT; Schema: public; Owner: vanpuffelen
--
...
--
-- Name: properties properties_atomic_number_key; Type: CONSTRAINT; Schema: public; Owner: vanpuffelen
--
...
--
-- Name: properties properties_pkey; Type: CONSTRAINT; Schema: public; Owner: vanpuffelen
--
